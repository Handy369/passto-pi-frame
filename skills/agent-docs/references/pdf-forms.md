...
> **Related**: PDF 基础操作见 [pdf.md](pdf.md) | PDF 高级操作见 [pdf-advanced.md](pdf-advanced.md)

**CRITICAL: You MUST complete these steps in order. Do not skip ahead to writing code.**

If you need to fill out a PDF form, first check to see if the PDF has fillable form fields. Run this script from this file's directory:
 `python scripts/pdf/check_fillable_fields <file.pdf>`, and depending on the result go to either the "Fillable fields" or "Non-fillable fields" and follow those instructions.

# Fillable fields
If the PDF has fillable form fields:
- Run this script from this file's directory: `python scripts/pdf/extract_form_field_info.py <input.pdf> <field_info.json>`. It will create a JSON file with a list of fields in this format:
```
[
  {
...
`python scripts/pdf/convert_pdf_to_images.py <file.pdf> <output_directory>`
...
`python scripts/pdf/convert_pdf_to_images.py <input.pdf> <images_dir/>`
...
`python scripts/pdf/convert_pdf_to_images.py <output.pdf> <verify_images/>`
