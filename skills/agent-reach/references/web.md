...
| 场景 | 推荐工具 |
|-----|---------|
| 先做互联网资料聚合研究 | DeepSeek smart-search（见 `references/search.md`） |
| 通用网页正文抓取 | Jina Reader (`curl r.jina.ai`) |
...
| 关联文档 | 关联内容 |
|----------|----------|
| [SKILL.md](../SKILL.md) | 主路由器，含 DeepSeek → Exa → Jina 的降级链 |
| [references/search.md](search.md) | 搜索结果页面读取（DeepSeek / Exa search → web 组合）|
| [references/social.md](social.md) | 微信公众号搜索（Exa 在 search.md 搜索微信域名，结果在 web.md 读取）|
